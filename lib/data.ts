export const site = {
  ...
  address: {
    development: "10 Shin Way, Canmore Heights, Dunfermline",
  },
} as const;
...
export const bookingOptions = [
  {
    ...
    duration: "30 min",
    description:
      "A focused chat to explore your project, goals and whether we're a good fit.",
